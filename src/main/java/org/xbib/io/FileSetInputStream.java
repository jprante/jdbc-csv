...
public class FileSetInputStream extends InputStream {
     ...
     * @param fileNamePattern      the regular expression describing the file name
     ...
     *                             ",").
     * @param prepend              whether the extra fields should precede the ones from the
     *                             file content.
     * @param headerless
    ...
    public FileSetInputStream(String dirName, String fileNamePattern,
                              ...
                              boolean headerless, int skipLeadingDataLines)
            throws IOException {
